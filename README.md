...
| 포트 | 용도 |
|---|---|
| UDP 9002 | Gazebo ArduPilot JSON/FDM 연결 |
| TCP 5760 | SITL 기본 MAVLink, MAVProxy master |
| TCP 5762 | 추가 MAVLink client/test |
| TCP 5763 | YOLO GUIDED controller |
| UDP 14550 | Mission Planner/GCS |
| UDP 14551 | 조이스틱 및 보조 MAVLink client |
| UDP 5600 | Gazebo 하향 카메라 H.264 stream |
